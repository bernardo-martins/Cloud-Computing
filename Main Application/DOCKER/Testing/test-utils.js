...
var statsRegExpr = [ [/.*\/rest\/media\/.*/,"GET","/rest/media/get/*"],
			[/.*\/rest\/media/,"POST","/rest/media/upload"],
			[/.*\/rest\/users\/.*\/channels/,"GET","/rest/users/*/channels"],
			[/.*\/rest\/users\/.*/,"GET","/rest/users/get/*"],
			[/.*\/rest\/users\/.*\/subscribe\/.*/,"POST","/rest/users/*/subscribe/*"],
			[/.*\/rest\/users\/auth/,"POST","/rest/users/auth"],
			[/.*\/rest\/users/,"POST","/rest/users/create"],
			[/.*\/rest\/channels\/.*\/add\/.*/,"POST","/rest/channels/*/add/*"],
			[/.*\/rest\/channels/,"POST","/rest/channels/create"],
			[/.*\/rest\/channels\/.*\/messages.*/,"GET","/rest/channels/*/messages"],
			[/.*\/rest\/channels\/.*/,"GET","/rest/channels/get/*"],
			[/.*\/rest\/messages/,"POST","/rest/messages/upload"],
			[/.*\/rest\/messages\/.*/,"GET","/rest/messages/get/*"]
	]
